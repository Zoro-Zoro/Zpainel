...
def menu():
	...
	(҂`_´) {br}- {vd}By: Zorro{cn}
	 <;︻╦╤─ ҉ - - - - - - - - - - - - -{vm}
	--=== >> {br}[   {vd}Zp4in3l{br}  ]
	{vm}-={az}[{cn}i{az}]{br}A consulta de nome está ofline!
	{l}
	...
	{br}- {az}[{cn}07{az}] {br}nome                               {br}-
	{br}- {az}[{cn}08{az}] {br}covid                              {br}-
	{br}- {az}[{cn}09{az}] {br}meu ip                             {br}-
	{br}- {az}[{cn}00{az}] {br}Sair                               {br}-
	{l}
	""")
