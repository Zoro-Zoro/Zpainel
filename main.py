...
def menu():
	...
	--=== >> {br}[   {vd}Zp4in3l{br}  ]
	{l2}
	{br}- {az}[{cn}01{az}] {br}ip           {br}[{vd}ON{br}]
	{br}- {az}[{cn}02{az}] {br}cep          {br}[{vd}ON{br}]
	{br}- {az}[{cn}03{az}] {br}cnpj         {br}[{vd}ON{br}]
	{br}- {az}[{cn}04{az}] {br}cpf          {br}[{vd}ON{br}]
	{br}- {az}[{cn}05{az}] {br}numero       {br}[{vd}ON{br}]
	{br}- {az}[{cn}06{az}] {br}localidade   {br}[{vd}ON{br}]
	{br}- {az}[{cn}07{az}] {br}nome         {br}[{vd}ON{br}]
	{br}- {az}[{cn}08{az}] {br}covid        {br}[{vd}ON{br}]
	{br}- {az}[{cn}09{az}] {br}meu ip       {br}[{vd}ON{br}]
	{br}- {az}[{cn}00{az}] {br}Sair         {br}[{vd}ON{br}]
	{l2}
	""")
